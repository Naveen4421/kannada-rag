...
def index_size():
    ...
    try:
        from retrieval.retrieve.search import _default_client, _defaults
...
def components(route, index_size_value=None):
    from common.embedding_model import MODEL_NAME as EMBED_MODEL, SPARSE_MODEL_NAME
    from common.llm import MODEL_NAME as LLM_MODEL
    from retrieval.retrieve.reranker_model import RERANKER_MODEL
