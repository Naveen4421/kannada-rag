...
from retrieval.generation.context_builder import build_evidence_prompt, strip_insufficient_marker
from retrieval.pipeline.errors import StageError
from retrieval.pipeline.rag_core import retrieve_evidence
from retrieval.validation.grounding import feedback_lines, validate_grounding
...
def default_generate(prompt, trace=None):
    from common.llm import MODEL_NAME, generate_answer_with_usage
...
def _default_variants(question):
    from retrieval.retrieve.query_expansion import generate_query_variants
