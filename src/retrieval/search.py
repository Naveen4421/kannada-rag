...
from src.retrieval.types import RetrievalOutput, RetrievalResult


# Resolved lazily (see _defaults) so this module imports without the ML stack.
def _defaults():
    from src.embeddings.embed import COLLECTION_NAME, get_client
...
def hybrid_search(query, top_k=10, where=None, question_embedding=None, sparse_vector=None,
    ...
    try:
        ...
        if sparse_vector is None:
            from src.embeddings.model import embed_sparse_query
